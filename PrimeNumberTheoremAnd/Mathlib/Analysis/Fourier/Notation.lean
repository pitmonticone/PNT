...
@[simp]
lemma fourierₗ_apply (f : E) : fourierₗ R E F f = fourier f := rfl

@[simp]
lemma fourier_zero : fourier (0 : E) = 0 :=
...
@[simp]
lemma fourierInvₗ_apply (f : E) : fourierInvₗ R E F f = fourierInv f := rfl

@[simp]
lemma fourierInv_zero : fourierInv (0 : E) = 0 :=
...
@[simp]
lemma fourierEquiv_apply (f : E) : fourierEquiv R E F f = fourier f := rfl

@[simp]
lemma fourierEquiv_symm_apply (f : F) : (fourierEquiv R E F).symm f = fourierInv f := rfl
