...
Purely numerical calculations from [reference].  This is kept in a separate file from the main file to avoid heavy recompilations.  Because of this, this file should not import any other files from the PNT+ project, other than further numerical data files.
-/
...
--   rw [← pow_lt_pow_iff_left₀ (by admit) (n := 3), ← rpow_mul_natCast] <;> norm_num only

set_option maxRecDepth 10000 in
/-- The entries in Table 14 obey the criterion in Sublemma \ref{bklnw-thm-1a-checked}.
-/
